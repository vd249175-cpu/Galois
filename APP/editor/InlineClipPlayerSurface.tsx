...
export function InlineClipPlayerSurface(props: any) {
  const {
    absoluteVideoPath, duration, end, error, fileName, handleFullscreen, handleLoaded,
    handleScrubStart, handleTimeUpdate, isHovered, isPlaying, loaded, playheadRef,
    progressFillRef, setError, setIsHovered, setIsPlaying, showOverlay, start,
    scrubBarRef, timeReadRef, togglePlay, videoRef, videoSrc, label,
  } = props;
  return (
    <div
      ...
      >
        ...
        {error && (
          ...
          >
            ...
            {absoluteVideoPath && (
              <MpvFallbackButton filePath={absoluteVideoPath} title={label || fileName} start={start} end={end} />
            )}
          </div>
        )}
