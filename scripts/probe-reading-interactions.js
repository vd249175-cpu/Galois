...
assert.match(readingPasteReveal, /isFullyVisibleWithin/);
assert.match(readingPasteReveal, /getBoundingClientRect/);
assert.match(readingPasteReveal, /if \(!isFullyVisibleWithin\(container, wrapper\)\)/);
assert.match(readingPasteReveal, /image\.addEventListener\('load', revealIfNeeded/);
