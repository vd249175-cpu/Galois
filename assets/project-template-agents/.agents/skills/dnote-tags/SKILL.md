---
name: dnote-tags
description: Development guide for Galois tag indexing syntax, covering static inline tags, regular expression matches, and python script-based dynamic tags resolver covenants.
---
