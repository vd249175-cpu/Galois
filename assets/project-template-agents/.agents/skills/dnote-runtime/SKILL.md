---
name: dnote-runtime
description: Guidelines on how to read and interpret Galois's note project runtime coordinates (.dnote_runtime.json) to synchronize AI context with user cursor position and focused files.
---
...
当协助用户在 Galois 项目中编写文档、调试脚本或解决问题时：
